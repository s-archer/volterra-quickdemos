resource "aws_eks_cluster" "eks" {
  ...
  vpc_config {
    subnet_ids = [aws_subnet.eks_control[0].id, aws_subnet.eks_control[1].id, aws_subnet.eks_control[2].id]
  }
...
resource "aws_eks_node_group" "eks-nodes" {
  ...
  subnet_ids     = [aws_subnet.eks_worker[0].id, aws_subnet.eks_worker[1].id, aws_subnet.eks_worker[2].id]
