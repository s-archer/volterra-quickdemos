...
#   cluster_name    = var.f5xc_sms_name
#   cluster_size    = var.master_node_count
#   hostname        = format("%s-m%s", var.f5xc_sms_name, count.index)
...
#   f5xc_site_name  = var.f5xc_sms_name
...
#   cluster_name    = var.f5xc_sms_name
#   cluster_size    = var.master_node_count
#   hostname        = format("%s-w%s", var.f5xc_sms_name, count.index)
#   wait_time       = var.f5xc_registration_wait_time
#   retry           = var.f5xc_registration_retry
#   tunnel_type     = var.f5xc_tunnel_type
# }
